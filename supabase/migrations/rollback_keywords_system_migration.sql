-- ROLLBACK Migration - Only run if you need to restore the keywords system
-- WARNING: This will recreate the table but data will be lost

-- Recreate the whatsapp_support_keywords table
