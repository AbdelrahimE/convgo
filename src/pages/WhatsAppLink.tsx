        ...
        <div className="flex flex-col items-center text-center space-y-8 md:space-y-10">
          ...
          <div className="w-full max-w-2xl space-y-8">
            ...
            <div className="space-y-4">
              <Button onClick={onCreateClick} className="w-full md:w-auto md:min-w-[200px]" size="lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="outline" className="flex-1" size="lg" onClick={() => window.open("https://doc.evolution-api.com/overview/about-evolution", "_blank")}>
...
const WhatsAppLink = () => {
  ...
  return <div className="container max-w-7xl mx-auto p-4 md:p-6 lg:p-8 min-h-[calc(100vh-4rem)]">
      ...
      {showCreateForm && <Card className="mb-8">
          ...
          if (validateInstanceName(instanceName)) {
            createInstance(instanceName);
              ...
              validateInstanceName(e.target.value);
                ...
                {!isValidName && <p className="text-xs md:text-sm text-red-500">
                    Instance name can only contain letters and numbers
                  </p>}
              </div>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button type="submit" disabled={isLoading || !isValidName || !instanceName} className="w-full" size="lg">
                  {isLoading ? <>
      ...
      {instances.length > 0 ? <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {instances.map(instance => <Card key={instance.id} className="flex flex-col transition-all duration-200 hover:shadow-lg">
              ...
              <CardContent className="flex-grow">
                {(instance.status === 'CREATED' || instance.status === 'CONNECTING') && instance.qr_code && <div className="flex flex-col items-center space-y-2">
